...
function deserialize_hello_HelloRequest(buffer_arg) {
  return proto_hello_pb.HelloRequest.deserializeBinary(
...
function deserialize_hello_HelloResponse(buffer_arg) {
  return proto_hello_pb.HelloResponse.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}
...
exports.HelloServiceClient = grpc.makeGenericClientConstructor(
  HelloServiceService
);
